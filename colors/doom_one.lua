...
local groups = {
  ...
  Directory = { fg = palettes.purple_dark, bg = palettes.none, style = "bold" }, -- directory names (and other special names in listings)
  ...
  StatusLine = { fg = palettes.h1_md, bg = palettes.bg1, style = "bold" },
  StatusLineCustom = { fg = palettes.bg1, bg = palettes.h1_md, style = "bold" },
  StatusLineNormal = { fg = palettes.white, bg = palettes.bg1, style = "bold" },
  StatusLineInsert = { fg = palettes.bg1, bg = palettes.green, style = "bold" },
  StatusLineExtra = { fg = palettes.none, bg = palettes.none, style = "bold" },
  StatusLineVisual = { fg = palettes.bg1, bg = palettes.yellow, style = "bold" },
  StatusLineReplace = { fg = palettes.bg1, bg = palettes.red, style = "bold" },
  StatusLineCmd = { fg = palettes.bg1, bg = "#7aa2f7", style = "bold" },
  StatusLineNC = { fg = palettes.gray, style = "bold" },
  StatusLineTerm = { fg = palettes.fg, bg = palettes.bg_hl, style = "bold" },
  StatusLineTermNC = { fg = palettes.fg, bg = palettes.bg_hl, style = "bold" },
  ...
  GitSignsCurrentLineBlame = { fg = palettes.gray },
  -- fzf lua
  ...
  FzfLuaCursorLine = { fg = palettes.black, bg = palettes.dark_cyan, style = "bold" },
