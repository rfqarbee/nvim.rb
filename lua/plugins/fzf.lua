return {
  ...
  config = function()
    ...
    map("n", "<leader>gL", fzf.git_bcommits, { desc = "Git Current Buffer/File Commits" })
    map("n", "<leader>gl", fzf.git_commits, { desc = "Project Commits" })
    -- diagnostic
    ...
    map("n", "<leader>ps", fzf.grep_curbuf, { desc = "Current Buffer Grep" })
